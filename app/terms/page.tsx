        ...
        <div className="relative bg-white/85 backdrop-blur-md rounded-3xl p-10 md:p-16 shadow-xl space-y-8 text-black">
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              confidentiality of your email communications.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              described in our Privacy Policy. <strong>Your location data is processed temporarily 
              and is not stored.</strong>
            </p>
          </section>
