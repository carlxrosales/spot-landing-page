        ...
        <div className="relative bg-white/85 backdrop-blur-md rounded-3xl p-10 md:p-16 shadow-xl space-y-8 text-black">
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              <strong className="block mt-2">Important: We do not collect or store any of your personal information.</strong> We only process information temporarily to provide you with place recommendations.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Survey responses and preferences (processed in real-time, not stored)</li>
            ...
            <p className="text-lg mt-4">
              <strong>Your location data is processed in real-time and is not stored.</strong> You can revoke location permissions at any time through your device settings.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mt-4">
              All processing happens in real-time. Once the recommendation is generated, the processed information is discarded and not stored.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              , in which case we will have access to your email address and message content for the purpose of responding to your inquiry.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              There is no data retention because there is no data stored.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              If you have any questions or concerns about how we process your information, please contact us at{" "}
              <a href="mailto:hey@carlrosales.com" className="text-neon-pink hover:underline">
                hey@carlrosales.com
              </a>
              .
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              we have processed information from a child under 13, please contact us immediately.
            </p>
          </section>
